    ...
    <aside id="sidebar-container" class="sidebar-wrapper">
        <div class="sidebar-inner">
            ...
            <nav class="flex-grow-1 overflow-auto d-flex flex-column gap-1">
                <a href="#" class="nav-link-custom" title="Tổng quan">
                    <i data-lucide="layout-grid"></i>
                    <span class="nav-text">Tổng quan</span>
                </a>

                <a href="#" class="nav-link-custom" title="Công việc">
                    <i data-lucide="folder-kanban"></i>
                    <span class="nav-text">Công việc</span>
                </a>

                <a href="#" class="nav-link-custom active" title="Dự án">
                    <i data-lucide="briefcase"></i>
                    <span class="nav-text">Dự án</span>
                </a>


                <a href="#" class="nav-link-custom" title="Nhân viên">
