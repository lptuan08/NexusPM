...
<head>
    ...
    <?php if (isset($extra_css)): ?>
        <?php foreach ((array) $extra_css as $cssFile): ?>
            <?php $extraCssPath = APPROOT . '/public/assets/css/' . $cssFile . '.css'; ?>
            <link rel="stylesheet" href="<?= URLROOT; ?>/assets/css/<?= htmlspecialchars($cssFile, ENT_QUOTES, 'UTF-8') ?>.css?v=<?= file_exists($extraCssPath) ? filemtime($extraCssPath) : time() ?>">
        <?php endforeach; ?>
    <?php endif; ?>
