...
<div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3 mb-4">
    <div class="d-flex align-items-center text-slate-600 fs-6">
        ...
        <?php if(isset($user['name'])):?>
            <a href="<?= URLROOT ?>/nguoi-dung/chi-tiet/<?= $user['id'] ?>" class="text-decoration-none text-slate-500 hover-text-primary"><?= htmlspecialchars($user['name']) ?></a>
            <span class="mx-2 text-slate-400 d-flex align-items-center" style="width: 16px;"><i data-lucide="chevron-right" size="16"></i></span>
    ...
    <div class="d-flex align-items-center gap-2">
        <a href="<?= URLROOT ?>/nguoi-dung" class="btn btn-outline-secondary px-3">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-12 mt-4 pt-3 border-top border-slate-100">
                                <div class="d-flex gap-2">
                                    ...
                                    <a href="<?= URLROOT ?>/nguoi-dung" class="btn btn-outline-secondary px-4">Hủy bỏ</a>
                                </div>
                            </div>
                        </div>
                    </form>
